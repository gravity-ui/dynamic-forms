...
| viewSpec.selectParams                  | `object`                 |          | [Parameters](#selectparams) additional options for the selector                                                                                                                         |
| viewSpec.showGenerateRandomValueButton | `boolean`                |          | Shows a button that allows you to generate a random value depending on the passed [function generateRandomValue](./lib.md#dynamicfield)                                                 |
