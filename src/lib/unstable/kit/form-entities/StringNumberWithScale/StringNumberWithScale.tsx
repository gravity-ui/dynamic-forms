...
const StringNumberWithScaleComponent: NodeEntity<JsonSchemaString, StringNumberWithScaleProps> = ({
    input,
    meta,
    props,
    schema,
...
export const StringNumberWithScale = React.memo(StringNumberWithScaleComponent);
