...
import './NumberWithScaleInput.scss';

const b = block('number-with-scale-input');

export interface NumberWithScaleInputProps
    extends Omit<
        NumberInputProps,
        | 'defaultValue'
        | 'value'
...
export const NumberWithScaleInput: NodeEntity<JsonSchemaNumber, NumberWithScaleInputProps> = ({
    input,
    meta,
    props,
    schema,
    ...
    const preparedInputProps = React.useMemo(() => {
        ...
        const result = {
            ...
            value: inputValue === undefined ? null : inputValue,
            onUpdate: onChange,
        };
