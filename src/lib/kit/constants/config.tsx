...
export const dynamicConfig: DynamicFormConfig = {
    ...
    object: {
        inputs: {
            ...
            oneof_type: {Component: OneOfType, independent: true},
            oneof_type_flat: {Component: OneOfTypeFlat, independent: true},
...
export const dynamicViewConfig: DynamicViewConfig = {
    ...
    object: {
        views: {
            ...
            oneof_type: {Component: OneOfTypeView, independent: true},
            oneof_type_flat: {Component: OneOfTypeFlatView, independent: true},
            secret: undefined,
