...
export default {
    title: 'Unstable/Array/CheckboxGroupInput',
...
const createStory = (layout: string | undefined, layoutName: string): StoryFn => {
    const schema: JsonSchema = {
        ...
        nodeParameters: {
            ...
            entityProps: {
                direction: 'column',
                enumDescriptions: {monday: 'Mon', tuesday: 'Tue', wednesday: 'Wed'},
            },
            layout,
        },
    };
    const Template: StoryFn = () => (
        <EntityPreview
            correctValue={['monday', 'tuesday']}
            incorrectValue={['monday']}
            title={`CheckboxGroupInput entity + ${layoutName}`}
            schema={schema}
        />
    );
