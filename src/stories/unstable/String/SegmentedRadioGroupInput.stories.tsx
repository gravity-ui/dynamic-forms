...
export default {
    title: 'Unstable/String/SegmentedRadioGroupInput',
...
const createStory = (layout: string | undefined, layoutName: string): StoryFn => {
    const schema: JsonSchema = {
        ...
        title: 'Choice',
        description: 'Segmented radio group field',
        enum: ['foo', 'bar', 'rab'],
        nodeParameters: {
            type: NodeType.String,
            entity: 'segmented_radio_group',
            entityProps: {
                enumDescriptions: {foo: 'Option 1', bar: 'Option 2', rab: 'Option 3'},
            },
            layout,
        },
    };
    const Template: StoryFn = () => (
        <EntityPreview
            ...
            title={`SegmentedRadioGroupInput entity + ${layoutName}`}
            schema={schema}
        />
    );
